...
public class EntregaPagamentoPendenteQueueAdapterIN implements IEntregaQueueAdapterIN {
    ...
    private final IRegistrarAgendamentoEntregaUseCase registrarAgendamentoEntrega;

    @Autowired
    public EntregaPagamentoPendenteQueueAdapterIN(IRegistrarAgendamentoEntregaUseCase registrarAgendamentoEntrega){

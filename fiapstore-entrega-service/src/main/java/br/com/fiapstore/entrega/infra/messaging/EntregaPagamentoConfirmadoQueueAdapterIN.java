...
public class EntregaPagamentoConfirmadoQueueAdapterIN implements IEntregaQueueAdapterIN {
    ...
    private final IConfirmarAgendamentoEntregaUseCase confirmarAgendamentoEntrega;


    @Autowired
    public EntregaPagamentoConfirmadoQueueAdapterIN(IConfirmarAgendamentoEntregaUseCase confirmarAgendamentoEntrega){
